  ...
  <div class="container">
    ...
    <div class="row mx-auto bg-white p-4">
      ...
      @if(count($recetas) > 0)
          ...
          <div class="col-md-4 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="{{ route('recetas.show', ['receta' => $receta->id]) }}" class="btn btn-outline-primary d-block mt-4 text-uppercase font-weight-bold">Ver Receta</a>
              </div>
        ...
        @endforeach
      @else
        <p class="text-center w-100">No se han creado recetas aún...</p>
      @endif
